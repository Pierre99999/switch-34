...
export async function POST(req: NextRequest) {
  ...
  const message = await client.messages.create({
    ...
    max_tokens: 1536,
    system: 'You are extracting structured company intelligence from a website for a sales CRM. Be concise — 1-3 sentences per field. Use empty string for fields not evidenced in the content.' + localeInstruction(locale),
    tools: [
      {
