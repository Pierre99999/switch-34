    ...
    <div className="min-h-screen flex items-center justify-center bg-white px-6">
      <div className="w-full max-w-sm">
        <div className="mb-10">
          ...
          <h1 className="font-serif text-3xl text-stone-900 italic">{t('auth.signup')}</h1>
        ...
        <p className="mt-6 text-xs text-stone-500 font-mono text-center">
          {t('auth.hasAccount')}{' '}
          <Link href="/login" className="text-stone-900 hover:underline">{t('auth.signInLink')}</Link>
        </p>
      </div>
    </div>
  )
