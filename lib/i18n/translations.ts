...
export const translations = {
  ...
  'newDeal.salesContextHint': { en: 'This is the most important field. Take the time to write in detail what you know: the real problem, who suffers from it, what\'s at stake, who decides, and what could block or accelerate a decision.', fr: 'C\'est le champ le plus important. Prenez le temps d\'écrire en détail ce que vous savez : le vrai problème, qui en souffre, les enjeux, qui décide, et ce qui pourrait bloquer ou accélérer une décision.' },
