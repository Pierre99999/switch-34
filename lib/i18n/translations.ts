...
export const translations = {
  ...
  'nav.profile': { en: 'Sales Playbook', fr: 'Sales Playbook' },
  ...
  'onboarding.roleDirectorDesc': { en: 'I oversee the full pipeline and own the Sales Playbook', fr: 'Je supervise le pipeline complet et détiens le Sales Playbook' },
  ...
  'onboarding.profileStep': { en: 'Your Sales Playbook', fr: 'Votre Sales Playbook' },
  'onboarding.profileStepDesc': { en: 'Import your website or a document to pre-fill the socle — segments, targets, positioning, perception objections.', fr: 'Importez votre site ou un document pour pré-remplir le socle — segments, cibles, positionnement, objections de perception.' },
  ...
  'onboarding.importingProfile': { en: 'Building the playbook…', fr: 'Construction du playbook…' },
  'onboarding.profileImported': { en: 'Playbook pre-filled!', fr: 'Playbook pré-rempli !' },
  ...
  'newDeal.saveTemplate': { en: 'Save as default for future prospects', fr: 'Enregistrer comme modèle pour les prochains prospects' },
  'newDeal.templateSaving': { en: 'Saving…', fr: 'Enregistrement…' },
  'newDeal.templateSaved': { en: '✓ Saved as default', fr: '✓ Modèle enregistré' },
  'newDeal.templateAvailable': { en: 'Default template loaded', fr: 'Modèle par défaut chargé' },
  ...
  'newDeal.contactRole': { en: 'Role in the decision', fr: 'Rôle dans la décision' },
  ...
  'layer.q2': { en: '« Can I sell? »', fr: '« Est-ce que je peux vendre ? »' },
  'layer.q3': { en: '« What impact — will it be adopted? »', fr: '« Quel impact — sera-t-il adopté ? »' },
  'layer.q4': { en: '« Is a decision being built? »', fr: '« Une décision se construit-elle ? »' },
  'gate.label': { en: 'GATE', fr: 'PORTE' },
  'gate.momentumLabel': { en: 'MOMENTUM · IN PARALLEL', fr: 'MOMENTUM · EN PARALLÈLE' },
  'gate.p1Subtitle': { en: 'All five conditions are necessary.', fr: 'Les cinq conditions sont toutes nécessaires.' },
  'gate.blocked': { en: 'Blocked — {var} < 2', fr: 'Bloquée — {var} < 2' },
  'gate.waiting': { en: 'READY — waiting for gate {n}', fr: 'PRÊTE — en attente porte {n}' },
  'gate.urgencyProven': { en: 'Urgency proven', fr: 'Urgence prouvée' },
  'gate.momentumStagnant': { en: 'Momentum is stalling — propose a dated, shared tempo.', fr: 'Le momentum stagne — proposez un tempo daté et partagé.' },
  ...
  'evidence.verified': { en: 'Quantified', fr: 'Chiffré' },
  ...
  'briefing.intentLabel': { en: 'Context', fr: 'Contexte' },
  'briefing.questionLabel': { en: 'Question to ask', fr: 'Question à poser' },
  'briefing.subQuestionsLabel': { en: 'Follow-up questions', fr: 'Questions complémentaires' },
  ...
  'capture.onCall': { en: 'On call', fr: 'En appel' },
  'capture.onCallClose': { en: 'Done', fr: 'Terminé' },
  'capture.onCallHint': { en: 'Tap a question to mark it asked. Pressing questions first, opportunistic ones last.', fr: 'Touchez une question pour la marquer posée. Les questions pressantes d\'abord, les opportunistes ensuite.' },
  'capture.opportunistic': { en: 'Opportunistic', fr: 'Opportuniste' },
  ...
  'dashboard.welcomePoint2': { en: 'No conversation has taken place yet — this is the starting point.', fr: 'Aucune conversation n\'a encore eu lieu — c\'est le point de départ.' },
  ...
  'voiceRole.decideur': { en: 'Decision maker', fr: 'Décideur' },
  'voiceRole.champion': { en: 'Champion', fr: 'Champion' },
  'voiceRole.acheteur_technique': { en: 'Technical decider', fr: 'Décideur technique' },
  'voiceRole.gardien_du_budget': { en: 'Budget guardian', fr: 'Gardien du budget' },
  'voiceRole.utilisateur': { en: 'End user', fr: 'Utilisateur' },
  'voiceRole.bloqueur': { en: 'Blocker', fr: 'Bloqueur' },
  'voiceRole.unknown': { en: 'Unknown role', fr: 'Rôle inconnu' },
  ...
  // ── Profile ──
  'profile.title': { en: 'Sales Playbook', fr: 'Sales Playbook' },
  ...
  'common.aiUnavailable': { en: 'The AI service is temporarily unavailable. Please try again.', fr: 'Le service IA est temporairement indisponible. Réessayez dans un instant.' },
  'verdict.EMPTY': { en: 'EMPTY', fr: 'VIDE' },
  'verdict.A_RISQUE': { en: 'AT RISK', fr: 'À RISQUE' },
  'verdict.EN_CONSTRUCTION': { en: 'IN PROGRESS', fr: 'EN CONSTRUCTION' },
  'verdict.FRANCHIE': { en: 'PASSED', fr: 'FRANCHIE' },
  'verdict.PRETE': { en: 'READY', fr: 'PRÊTE' },
  'verdict.VIVANT': { en: 'ALIVE', fr: 'VIVANT' },
  'verdict.FRAGILE': { en: 'FRAGILE', fr: 'FRAGILE' },
  'verdict.EN_PANNE': { en: 'STALLED', fr: 'EN PANNE' },
  'verdict.EN_OBSERVATION': { en: 'OBSERVING', fr: 'EN OBSERVATION' },
    'timeline.initial': { en: 'Start', fr: 'Départ' },
  'ai.step.profile': { en: 'Analyzing your vendor profile…', fr: 'Analyse de votre profil vendeur…' },
  'ai.step.context': { en: 'Analyzing the prospect context…', fr: 'Analyse du contexte prospect…' },
  'ai.step.scores': { en: 'Reviewing scores and history…', fr: 'Revue des scores et de l\'historique…' },
  'ai.step.questions': { en: 'Writing the conversation plan…', fr: 'Rédaction du plan de conversation…' },
  'ai.step.finalize': { en: 'Finalizing the briefing…', fr: 'Finalisation du briefing…' },
  'ai.step.notes': { en: 'Reading your capture notes…', fr: 'Lecture de vos notes de conversation…' },
